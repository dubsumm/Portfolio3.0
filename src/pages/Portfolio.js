...
export default function Portfolio() {
  return (
    <div className="homePage aboutp">
      <h2 className="text-center text-uppercase text-white p-4 m-auto headersBG">
        My work so far
      </h2>
      <div className="mx-auto  lg:w-8/12 sm:10/12 w-full grid grid-cols-1 sm:grid-cols-2  contactBG gap-4">
        ...
        <div className="text-white  w-full p-5 ">
          ...
          <p className="text-white ml-5 -mt-3"> (if you know where to look.)</p>
          <div className="grid grid-cols-2">
            <ul className=" h-full list-disc ">
              <p className="text-white mt-2 uppercase">Front-End</p>
              <li className="ml-4 -mt-3"> ReactJS</li>
              <li className="ml-4"> Bootstrap</li>
              <li className="ml-4"> Canvas</li>
            </ul>
            <ul className="list-disc">
              <p className="text-white mt-2 uppercase">Back-End</p>
        ...
        <div className="text-white  w-full p-5 ">
          ...
          <p className="text-white mt-2 uppercase text-center">Tech </p>
          <div className="grid grid-cols-2">
            <ul className=" h-full list-disc ">
